...
const require$$0 = craftercms.libs.React && Object.prototype.hasOwnProperty.call(craftercms.libs.React, 'default') ? craftercms.libs.React['default'] : craftercms.libs.React;
 ...
 */
var f$1=require$$0,k$1=Symbol.for("react.element"),l$1=Symbol.for("react.fragment"),m$1=Object.prototype.hasOwnProperty,n$1=f$1.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,p$1={key:!0,ref:!0,__self:!0,__source:!0};
...
function BulkPublishPanelButton() {
    ...
    return (jsxRuntimeExports.jsx(ToolsPanelListItemButton, { icon: { id: '@mui/icons-material/AutoAwesomeMotionOutlined' }, onClick: function () {
...
function BulkPublishView(props) {
    ...
    return (jsxRuntimeExports.jsx(Paper, { elevation: 2, sx: { height: '100%' }, children: jsxRuntimeExports.jsx(Box, { sx: { p: 1 }, children: hasInitialPublish$1 ? (jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [jsxRuntimeExports.jsx(Box, { sx: { paddingBottom: 1 }, children: jsxRuntimeExports.jsx(PathSelector, { value: path, disabled: false, onPathSelected: onPathSelected, stripXmlIndex: false }) }), jsxRuntimeExports.jsx(PublishOnDemandForm, { disabled: isSubmitting, formData: publishStudioFormData, setFormData: setPublishStudioFormData, mode: 'studio', publishingTargets: publishingTargets, publishingTargetsError: publishingTargetsError, bulkPublishCommentRequired: bulkPublishCommentRequired, publishByCommitCommentRequired: publishByCommitCommentRequired }), jsxRuntimeExports.jsx(Button, { sx: { float: 'right' }, variant: "contained", color: "primary", disabled: !publishStudioFormValid, onClick: onSubmitBulkPublish, children: "Bulk Publish" })] })) : (jsxRuntimeExports.jsxs(Box, { sx: {
                    ...
                    padding: theme.spacing(5)
                            ...
                            maxWidth: '470px',
                            textAlign: 'center'
                        }, children: jsxRuntimeExports.jsx(FormattedMessage, { id: "publishOnDemand.noInitialPublish", defaultMessage: "The project needs to undergo its initial publish before other publishing options become available" }) }), hasPublishPermission && (jsxRuntimeExports.jsx(Button, { variant: "contained", color: "primary", onClick: onInitialPublish, children: jsxRuntimeExports.jsx(FormattedMessage, { id: "publishOnDemand.publishEntireProject", defaultMessage: "Publish Entire Project" }) }))] })) }) }));
}
