...
const { useReducer, useEffect, useState } = craftercms.libs.React;
...
const { Paper, Typography, Box, Button } = craftercms.libs.MaterialUI;
...
const { PublishOnDemandForm } = craftercms.components;

var en$1 = {
	"org.craftercms.bulkpublish.sitesView.noContentTypesMessage": "There are no content types",
	"org.craftercms.bulkpublish.sitesView.numOfContentTypesMessage": "There {total, plural, one {is one content type} other {are {total} content types}}",
	"org.craftercms.bulkpublish.sitesView.numOfProjectsMessage": "You have {total, plural, one {one project} other {{total} projects}}",
	"org.craftercms.bulkpublish.vanilla.exampleTranslations": "Hello. This text is internationalized.",
	"org.craftercms.bulkpublish.vanilla.DialogTitle": "Bulk Publish Assets",
	"org.craftercms.bulkpublish.vanilla.bulkPublishTitle": "Bulk Publish Assets"
};

var es = {
	"org.craftercms.bulkpublish.sitesView.noContentTypesMessage": "No hay tipos de contenido",
	"org.craftercms.bulkpublish.sitesView.numOfContentTypesMessage": "Hay {total, plural, one {un tipo de contenido} other {{total} tipos de contenido}}",
	"org.craftercms.bulkpublish.sitesView.numOfProjectsMessage": "Hay {total, plural, one {un proyecto} other {{total} proyectos}}",
	"org.craftercms.bulkpublish.vanilla.exampleTranslations": "Hola. Este text esta traducido.",
	"org.craftercms.bulkpublish.vanilla.DialogTitle": "Recursos de publicación masiva",
	"org.craftercms.bulkpublish.vanilla.bulkPublishTitle": "Recursos de publicación masiva"
};
...
function BulkPublishPanelButton() {
...
function BulkPublishView(props) {
    ...
    var _b = useState('/static-assets'), path = _b[0], setPath = _b[1];
    var _c = useState(false), isSubmitting = _c[0], setIsSubmitting = _c[1];
    var _d = useSelection(function (state) { return state.uiConfig.publishing; }), bulkPublishCommentRequired = _d.bulkPublishCommentRequired, publishByCommitCommentRequired = _d.publishByCommitCommentRequired;
    var _e = useSpreadState(initialPublishStudioFormData), publishStudioFormData = _e[0], setPublishStudioFormData = _e[1];
    var _f = useState(null), hasInitialPublish$1 = _f[0], setHasInitialPublish = _f[1];
    var _g = useState(null), publishingTargets = _g[0], setPublishingTargets = _g[1];
    var _h = useState(null), publishingTargetsError = _h[0], setPublishingTargetsError = _h[1];
    ...
    if (hasInitialPublish$1 === null) {
        return (jsx(Paper, { elevation: 2, sx: { height: '100%' }, children: jsx(Typography, { children: "Loading..." }) }));
    }
    return (jsx(Paper, { elevation: 2, sx: { height: '100%' }, children: jsx(Box, { sx: { p: 1 }, children: hasInitialPublish$1 ? (jsxs(Fragment, { children: [jsx(Box, { sx: { paddingBottom: 1 }, children: jsx(PathSelector, { value: path, disabled: false, onPathSelected: onPathSelected, stripXmlIndex: false }) }), jsx(PublishOnDemandForm, { disabled: isSubmitting, formData: publishStudioFormData, setFormData: setPublishStudioFormData, mode: 'studio', publishingTargets: publishingTargets, publishingTargetsError: publishingTargetsError, bulkPublishCommentRequired: bulkPublishCommentRequired, publishByCommitCommentRequired: publishByCommitCommentRequired }), jsx(Button, { sx: { float: 'right' }, variant: "contained", color: "primary", disabled: !publishStudioFormValid, onClick: onSubmitBulkPublish, children: "Bulk Publish" })] })) : (jsxs(Box, { sx: {
                    display: 'flex',
                    alignItems: 'center',
                    ...
                    padding: theme.spacing(5)
                            ...
                            maxWidth: '470px',
                            textAlign: 'center'
                        }, children: jsx(FormattedMessage, { id: "publishOnDemand.noInitialPublish", defaultMessage: "The project needs to undergo its initial publish before other publishing options become available" }) }), hasPublishPermission && (jsx(Button, { variant: "contained", color: "primary", onClick: onInitialPublish, children: jsx(FormattedMessage, { id: "publishOnDemand.publishEntireProject", defaultMessage: "Publish Entire Project" }) }))] })) }) }));
}
...
export { BulkPublishPanelButton, BulkPublishView, plugin as default };
